...
/**
 * DJL自带的translator返回的对象外框是绝对坐标，转为相对坐标方便统一处理
 */
public class YoloRelativeTranslator implements Translator<Image, DetectedObjects> {
    private final YoloProperties yoloProperties;

    private final Translator<Image, DetectedObjects> delegated;

    public YoloRelativeTranslator(Translator<Image, DetectedObjects> translator, YoloProperties yolo) {
